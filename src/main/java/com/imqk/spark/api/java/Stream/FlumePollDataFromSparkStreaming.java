 ...
 *
 */
public class FlumePollDataFromSparkStreaming {
    public static void main(String[] args) {

        SparkConf conf = new SparkConf();
        conf.setAppName("FlumePollDataFromSparkStreaming");
        ...
        JavaReceiverInputDStream lines = FlumeUtils.createPollingStream(ssc, "master", 9999);
